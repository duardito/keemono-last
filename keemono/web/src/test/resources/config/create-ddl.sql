...
INSERT INTO layout(id,name,valores,user_id,uuid ) VALUES (1,'two-layout','<div id="2" class="row"><div id="3" class="col-xs-4"><div id="4" class="dragable"></div></div><div id="5" class="col-xs-8"><div id="6" class="dragable"></div></div></div>',1,'c695b78b-7218-4e53-897b-51d29c250911');
